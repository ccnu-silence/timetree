...
//        view.setTranslationY(fromTranslationY);
        ...
        set.playTogether(
            ObjectAnimator.ofFloat(view, "translationX", 0, toTranslationX),
            ObjectAnimator.ofFloat(view, "translationY", 0, toTranslationY),
            ObjectAnimator.ofFloat(view, "scaleX", toScale),
            ObjectAnimator.ofFloat(view, "scaleY",toScale)
        );
      ...
      //  ViewPropertyAnimator propertyAnimator = view.animate().translationX(toTranslationX).translationY(toTranslationY).scaleX(toScale).scaleY(toScale).setDuration(duration);
       // ViewPropertyAnimator propertyAnimator=ob
