...
//	private boolean mLock;
    ...
    public StartAnimationListener startAnimation;

    public StartAnimationListener getStartAnimation() {
        return startAnimation;
    }

    public RotateAnimation getmReverseFlipAnimation() {
        return mReverseFlipAnimation;
    }

    public void setmReverseFlipAnimation(RotateAnimation mReverseFlipAnimation) {
        this.mReverseFlipAnimation = mReverseFlipAnimation;
    }

    public void setStartAnimation(StartAnimationListener startAnimation) {
    ...
    public void setmFlipAnimation(RotateAnimation mFlipAnimation) {
        this.mFlipAnimation = mFlipAnimation;
    }

    private  final static String TAG = "PullToRefreshHeaderView";
...
//	private String mLastUpdateTime;
	...
	private void init() {
		...
		mReverseFlipAnimation.setDuration(1000);
...
//				footerPrepareToRefresh(deltaY);
		...
		case MotionEvent.ACTION_CANCEL:
			...
			if (mPullState == PULL_DOWN_STATE) {
				if (topMargin >= 0) {
					// 开始刷新
                    UtilsLog.i(TAG, "onTouchEvent--->开始刷新 ");
					headerRefreshing();
				} else {
					// 还没有执行刷新，重新隐藏
                    UtilsLog.i(TAG, "onTouchEvent--->没有执行刷新，重新隐藏");
...
//            UtilsLog.i(TAG, "headerPrepareToRefresh--->PULL_TO_REFRESH(松开刷新数据) ");
...
//                startAnimation.startAnimation();
//            }
//            UtilsLog.i(TAG, "headerPrepareToRefresh--->PULL_TO_REFRESH(下拉刷新) ");
...
//	}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(PullToRefreshHeaderView view);
	}
