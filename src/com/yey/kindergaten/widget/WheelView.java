...
public class WheelView extends TosGallery {
    ...
    private void initialize(Context context) {
        ...
        this.mSelectorDrawable = getContext().getResources().getDrawable(R.drawable.lay_wheel_bg);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mSelectorBound.set(0, top, getWidth() - getPaddingRight(), bottom);
//              mSelectorBound.set(0, top, 0, bottom)
    }
