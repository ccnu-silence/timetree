...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final float defaultStrokeWidth = res.getDimension(R.dimen.dimen_2_dip);
        final float defaultRadius = res.getDimension(R.dimen.dimen_4_dip);
        ...
        mCentered = a.getBoolean(2, defaultCentered);
        mOrientation = a.getInt(0, defaultOrientation);
