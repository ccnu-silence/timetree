package com.yey.kindergaten.widget.percent;
 ...
 * <p/>
 * <ol>
 * <li> You need a {@link android.view.ViewGroup.LayoutParams} subclass in your ViewGroup that implements
 ...
 * {@link PercentLayoutHelper#getPercentLayoutInfo(android.content.Context, android.util.AttributeSet)}. Return this
 ...
 * <li> Override
 * {@link android.view.ViewGroup.LayoutParams#setBaseAttributes(android.content.res.TypedArray, int, int)}
 * with a single line implementation {@code PercentLayoutHelper.fetchWidthAndHeight(this, a,
 * widthAttr, heightAttr);}
 * <li> In your ViewGroup override {@link android.view.ViewGroup#generateLayoutParams(android.util.AttributeSet)} to return
 * your LayoutParams.
 * <li> In your {@link android.view.ViewGroup#onMeasure(int, int)} override, you need to implement following
 * pattern:
 ...
 * }
 * </pre>
 * <li>In your {@link android.view.ViewGroup#onLayout(boolean, int, int, int, int)} override, you need to
...
public class PercentLayoutHelper
{
    ...
    /**
     * Helper method to be called from {@link android.view.ViewGroup.LayoutParams#setBaseAttributes} override
