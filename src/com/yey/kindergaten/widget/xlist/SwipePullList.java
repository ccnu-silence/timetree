...
package com.yey.kindergaten.widget.xlist;
...
public class SwipePullList extends ListView {
    ...
    public SwipePullList(Context context) {
        this(context,null);
    }

    public SwipePullList(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SwipePullList(Context context, AttributeSet attrs, int defStyle) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (mIsShown) {
                     ...
                     */
                    mPreItemView.setFocusable(false);
                    mPreItemView.setLongClickable(false);
                    hiddenRight(mPreItemView);
                }
