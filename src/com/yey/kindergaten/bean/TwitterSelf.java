...
@Table(name = "TwitterSelf")
public class TwitterSelf extends EntityBase {
	private int upload;
	@Column(column = "twrid")
	private int twrid;
	...
	private CommentsSelf[] comments;
	@Table(name="CommentsSelf")
	public static class CommentsSelf extends EntityBase{
		@Column(column = "twrid")
		private int twrid;
		@Column(column="cmtid")
		private int cmtid;
	...
	public CommentsSelf[] getComment() {
		return comments;
	}

	public void setComment(CommentsSelf[] comments) {
