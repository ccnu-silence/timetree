...
public class AccountInfo extends EntityBase implements Serializable {
    ...
    @Column(column = "job")
    private String job;
    @Column(column = "pmvurl")
    private String pmvurl;
    @Column(column = "apptitle")
    private String apptitle;
    @Column(column = "paygw")
    private String paygw;
    @Column(column = "paytitle")
    ...
    public String getPmvurl() {
        return pmvurl;
    }

    public void setPmvurl(String pmvurl) {
        this.pmvurl = pmvurl;
    }
