...
public class VideoUtils {
	...
	public static void startTrim(File src, File dst, long start, long end) throws IOException {
		com.googlecode.mp4parser.authoring.Movie movie = MovieCreator.build(src.getAbsolutePath());
	...
	public static void appendVideo(String[] videos, String desName) throws IOException {
        com.googlecode.mp4parser.authoring.Movie[] inMovies = new com.googlecode.mp4parser.authoring.Movie[videos.length];
		int index = 0;
