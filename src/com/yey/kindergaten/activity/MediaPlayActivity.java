...
import com.yey.kindergaten.widget.PopMenu;
import com.yey.kindergaten.widget.Subtitle;
import com.yey.kindergaten.widget.VerticalSeekBar;
...
public class MediaPlayActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.i("vedioplay"," MediaPlayActivity onCreate...");
        // 隐藏标题
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        Log.i("vedioplay"," MediaPlayActivity onConfigurationChanged...");
    }

    private void initView() {
        Log.i("vedioplay"," MediaPlayActivity initView...");
...
//      surfaceView.setZOrderOnTop(true);
        ...
        loading_ll = (LinearLayout) findViewById(R.id.loading_layout);
    }
    ...
    private void initPlayInfo() {
        ...
        try {
            if (!isLocalPlay) { // 播放线上视频
                player.setVideoPlayInfo(videoId, AppConstants.CC_USER_ID, AppConstants.CC_API_KEY, this);
...
//      subtitle.initSubtitleResource(subtitleExampleURL);
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        if (currentPosition > 0) {
            currentPosition = getIntent().getIntExtra("currention", 0);
...
//      definitionBtn.setVisibility(View.VISIBLE);
    ...
    protected void onDestroy() {
        ...
        alertHandler = null;
        Log.i("vedioplay"," MediaPlayActivity onDestroy...");
        if (player != null) {
            player.release();
            player = null;
        }
