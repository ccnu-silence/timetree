 ...
 *
 */
public class KindergatenCardActivity extends BaseActivity implements OnClickListener{
    ...
    private void initView() {
        ...
        ciciv.setVisibility(View.GONE);
        down.setOnClickListener(this);
//      down.setVisibility(View.GONE);
        miaoshutv.setText("扫一扫上面的二维码加入幼儿园");
        if (accountInfo.getKname()!=null && accountInfo.getKname()!="") {
            titletv.setText(accountInfo.getKname());
        } else {
            titletv.setText("未命名");
        }
        nametv.setText("扫一扫");
        ...
        try {
            bitmap = Create2DCode(AppUtils.replaceAddSchoolUrl(accountInfo.getKid()));
            ...
            if (portrait!=null) {
                ...
                portrait = Bitmap.createBitmap(portrait, 0, 0, (int) width, (int) height, mMatrix, true);
...
//           bm.compress(Bitmap.CompressFormat.JPEG, 100, baos);
             ...
             FileOutputStream fos = new FileOutputStream(new File(AppConfig.PATH, name));
             int options = 100;
     ...
     public void onClick(View arg0) {
         ...
         case R.id.down_to_phone_tv:
             /*if (accountInfo.getKname() == null|| accountInfo.getKname().equals("")) {
                 ...
                 last_name = accountInfo.getKname();
             }
             BitmapUtil.savePhotoToSDCard(bitmap, AppConfig.PATH, name+"_" + last_name+".png");
             showToast("文件保存到"+AppConfig.PATH+"目录中");*/
             Intent intent=new Intent(KindergatenCardActivity.this, MeShareActivity.class);
