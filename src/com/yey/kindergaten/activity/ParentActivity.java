...
public class ParentActivity extends BaseActivity implements OnItemClickListener, OnClickListener, PullToRefreshHeaderView.OnHeaderRefreshListener {
    ...
    private final static String TAG = "ParentActivity";

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.parentfragment);
...
//              }
        ...
        nodataddly = (FrameLayout) findViewById(R.id.fragmnetly_notitaddly);
        exListview = (ExpandableListView) findViewById(R.id.activity_contacts_main_parant_expandlv);
        noteacherBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AppUtils.startWebUrlForGuide(ParentActivity.this, url);
            }
        });
        ...
        if (contacts.getClasses() == null) {
            try {
                List<Classe>classes = DbHelper.getDB(AppContext.getInstance()).findAll(Classe.class);
                if (classes == null) {
        ...
        parentAdapter = new ParantAdapter(contacts.getClasses(), childrenList, this);
        ...
        try {
            List<Children> list = DbHelper.getDB(AppContext.getInstance()).findAll(Children.class);
    ...
    private void showRemindDialog(final Classe item){
        showDialog("提示", "去邀请", item.getCname() + "暂无家长加入，快去邀请吧。", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                AppUtils.startWebUrlForGuide(ParentActivity.this, AppUtils.replaceUrlByUrl(75, item.getCid()));
            }
        });
    }
    ...
    public void initdata(final Classe item){
        if (item!=null && item.getChildrencount() == 0) {
            ...
            Intent intent = new Intent(this, ContactsParentList.class);
            ...
            public void onAppRequest(int code, String message, Object obj) {
                ...
                if (code == AppServer.REQUEST_SUCCESS) {
                    ...
                    if (list!=null) {
                        ...
                        try {
                            DbHelper.getDB(ParentActivity.this).deleteAll(Classe.class);
                            DbHelper.getDB(ParentActivity.this).saveAll(list);
                        } catch (DbException e) {
                            e.printStackTrace();
                        }
                    }
            ...
            AppServer.getInstance().GetParentByCid(accountInfo.getUid(), contacts.getClasses().get(0).getCid(), new OnAooRequestParentListener() {
                ...
                public void onAppRequest(int code, String message, Object obj, Object obj2) {
                    if (code == AppServer.REQUEST_SUCCESS) {
                        ...
                        try {
                            DbHelper.getDB(ParentActivity.this).saveAll(childrenList);
                        } catch (DbException e) {
                            e.printStackTrace();
                        }
                        if (childrenList!=null || childrenList.size()!=0) {
                            ...
                            UtilsLog.i(TAG, "childrenList is null or size 0");
                        }
                    } else {
                        showToast("获取学生列表失败");
    ...
    class Holder {
        ...
        TextView titletv;
        TextView childrenCount_tv;
        TextView invite_parents_tv;
        ImageView pull_iv;
    }
    ...
    class ParantAdapter extends BaseExpandableListAdapter {
        ...
        @Override
        public View getGroupView(final int groupPositoin, boolean isExpanded, View convertView, ViewGroup viewGroup) {
            Holder holder;
            if (convertView == null) {
                holder = new Holder();
                ...
                holder.childrenCount_tv = (TextView)convertView.findViewById(R.id.childrenCount);
                holder.invite_parents_tv = (TextView)convertView.findViewById(R.id.invite_parents_tv);
...
//          }
            ...
            holder.childrenCount_tv.setVisibility(View.VISIBLE);
            holder.childrenCount_tv.setText(classe.getChildrencount() + "人");
            holder.mian_ly.setVisibility(View.VISIBLE);
            if (accountInfo!=null && accountInfo.getRights()!=null && accountInfo.getRights().contains("120")) {
                holder.invite_parents_tv.setVisibility(View.GONE);
            } else {
                holder.invite_parents_tv.setVisibility(View.VISIBLE);
            }
            holder.nametextView.setText(classe.getCname());
            holder.view.setVisibility(View.GONE);
            holder.imageView.setVisibility(View.GONE);
            holder.arrowiv.setVisibility(View.VISIBLE);
            holder.longview.setVisibility(View.GONE);
            holder.invite_parents_tv.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
//                  Toast.makeText(ParentActivity.this, grounpList.get(groupPositoin).getCid() + "", Toast.LENGTH_LONG).show();
                    AppUtils.startWebUrlForGuide(ParentActivity.this, AppUtils.replaceUrlByUrl(AppConstants.TEACHER_INVITE_PARENT, grounpList.get(groupPositoin).getCid()));
                }
            });
            return convertView;
        }
        ...
        public View getChildView(final int grounpPosition, final int childPosition, boolean lsLastChild, View convertView, ViewGroup viewGroup) {
            if (convertView == null) {
                convertView = LayoutInflater.from(context).inflate(R.layout.parentlistitem, null);
            }
            ...
            content.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(ParentActivity.this, ContactFriendDatacardActivity.class);
