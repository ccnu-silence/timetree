...
public class ServiceSelectFriendAdapter extends BaseAdapter{
    ...
    public ServiceSelectFriendAdapter(Context context, List<Friend>list, List<String>liststr) {
//      super(context, list);
    ...
    public ServiceSelectFriendAdapter(Context context, List<Friend>list, ListView view) {
//      super(context, list);
        this.context = context;
        this.list = list;
        this.view = view;
...
//              }
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (list.get(position).getNickname()!=null) {
            nickNameTv.setText(list.get(position).getNickname());
        }
        ...
        click.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ServiceSelectFriendAdapter.this.notifyDataSetChanged();
            }
        });
