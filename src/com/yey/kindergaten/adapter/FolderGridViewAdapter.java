...
public class FolderGridViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_grid_folder, null);
        ...
        viewHolder.folderIcon.setImageBitmap(lazyGallery.loadGallery(mContext, mFolder.get(position).getFolderIconUrl(), viewHolder.folderIcon, new LazyGallery.ImageCallback() {
