 ...
 */
package com.yey.kindergaten.huanxin.db;
...
import com.yey.kindergaten.huanxin.bean.InviteMessage;
import com.yey.kindergaten.huanxin.bean.InviteMessage.InviteMesageStatus;
	...
	public List<InviteMessage> getMessagesList(){
		...
		if(db.isOpen()){
			...
			while(cursor.moveToNext()){
				...
				else if(status == com.yey.kindergaten.huanxin.bean.InviteMessage.InviteMesageStatus.REFUSED.ordinal())
