...
public class ContextMenu extends BaseActivity {
    ...
    public void savephoto(View view){
        setResult(ChatActivity2.RESULT_CODE_SAVE_PHOTO, new Intent().putExtra("position", position));
        finish();
    }
	public void forward(View view){
		setResult(ChatActivity2.RESULT_CODE_FORWARD, new Intent().putExtra("position", position));
		finish();
	}
