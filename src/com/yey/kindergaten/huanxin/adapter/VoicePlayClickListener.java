...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((ChatActivity2) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((ChatActivity2) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		if (isPlaying) {
			if (((ChatActivity2) activity).playMsgId != null && ((ChatActivity2) activity).playMsgId.equals(message.getMsgId())) {
