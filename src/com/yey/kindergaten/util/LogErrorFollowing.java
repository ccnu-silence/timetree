...
public class LogErrorFollowing {
    ...
    /** 本类的TAG */
    private static final String TAG = "LogErrorFollowing";
    /** log日志保存地址 */
    ...
    /** log日志保存的文件名 */
    private static final String LOG_FILE_NAME = "errorfollowing";
    /** 文件644权限 */
    ...
    public static void e(String tag, String text) {
        isSaveFile = SharedPreferencesHelper.getInstance(AppContext.getInstance()).getBoolean(AppConstants.PREF_ISPRINTLOG_SWITCH, false);
        if (isDebug){
