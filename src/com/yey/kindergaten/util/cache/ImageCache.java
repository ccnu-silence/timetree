...
import com.yey.kindergaten.huanxin.vedio.util.RecyclingBitmapDrawable;
import com.yey.kindergaten.huanxin.vedio.util.Utils;
...
public class ImageCache {
            ...
            if (mDiskLruCache == null || mDiskLruCache.isClosed()) {
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) {
                        try {
                            mDiskLruCache = DiskLruCache2.open(
    ...
    public void addBitmapToCache(String data, BitmapDrawable value) {
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    DiskLruCache2.Snapshot snapshot = mDiskLruCache.get(key);
                    if (snapshot == null) {
                        final DiskLruCache2.Editor editor = mDiskLruCache.edit(key);
                        if (editor != null) {
    ...
    public BitmapDrawable getBitmapFromMemCache(String data) {
        ...
        if (UtilLocal.DEBUG && memValue != null) {
    ...
    public Bitmap getBitmapFromDiskCache(String data) {
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    final DiskLruCache2.Snapshot snapshot = mDiskLruCache.get(key);
                    if (snapshot != null) {
                        if (UtilLocal.DEBUG) {
