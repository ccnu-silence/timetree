...
public class AppConstants {
    ...
    public static final int PUSH_ACTION_FORCE_UPDATE = 49;  // 强制更新
    public static final int PUSH_ACTION_SYSTEM = 99;        // 系统消息()已作废)
    ...
    /***专用于更新服务器消息状态，便于服务器统计观察消息准点到达率***/
    public static final int GT_PUSH_PUBLIC_MESSAGE = 1 ;    // 个推公众号消息
    public static final int GT_PUSH_SYSTEM_MESSAGE = 2 ;    // 个推系统消息
    public static final int HX_PUSH_SYSTEM_MESSAGE = 3 ;    // 环信系统消息
    ...
    public static final String INTENT_IS_SHOWLOOKDATA = "intent_isshowlookdata";
    ...
    public static final String INTENT_FULL_SCREEN = "intent_full_screen";
    ...
    public static final String CONTACTS_PUACMAIN1 = "puacmain1";
    public static final String CONTACTS_PUACMAIN2 = "puacmain2";
    ...
    public static final String MEMAIN_MIDDLE = "memain_middle";
    ...
    public static final int GET_CONTACTS_OK = 1;
    public static final int GET_CONTACTS_FAIL = -1;
    public static final int GET_CONTACTS_DEFAULT = 0;
    ...
    public static final String PREF_ISPRINTLOG_SWITCH = "isprintlog";                       // 打印log开关
    public static final String PREF_SUPPORT_DIALOG_NOTICE_SWITCH = "support_Dialog_Notice"; // 离园播报弹框开关
    ...
    // 不同的dialog类型
    public static final String DIALOG_TYPE_BIRTHDAY = "birthday";  // 已发生日祝福dialog
    public static final String DIALOG_TYPE_PARENT = "parent_rigest";  // 家长注册提示
    ...
    // intent传值的常量
    public static List<Album> checkList = new ArrayList<Album>();       // 班级相册删除照片使用
    public static List<Object> photocheckList = new ArrayList<Object>(); // 删除照片使用
    public static List<Object> checklist = new ArrayList<Object>();
    public static final int NET_SENDMESSAG_WHAT_CODE_HASNET = 111;  // 表示没网
    public static final int NET_SENDMESSAG_WHAT_CODE_NONET = 000;   // 表示有网
    /**图片压缩质量--普通*/
    ...
    public  static final String PARAM_PHOTOSHOWGENERAL = "PhotoShowGeneral";
    ...
    /**职位顺序**/
    public static final  String[] JOBLIST = {"园长","副园长","业务园长","行政园长","后勤园长","保健医生","主任"
       ,"党支书","保教主任","主班老师","副班老师","专科老师","中文教师","英文教师","专任教师","兼任教师","代课老师",
        "生活老师","保育员","营养师","管理员"};
    ...
    public final static String[] SPECIAL_PUBLIC_IDS = {"11","12","13","16","17","18"};
    ...
    public static final String SAVE_PHOTO_PATH = new File(AppConstants.SAVE_PHOTO_PATH_MAIN).exists() ? AppConstants.SAVE_PHOTO_PATH_MAIN
        : Environment.getExternalStorageDirectory() + "/timetree/photo/";

    // 超时时间
    public static final String EXPIRATION = "expiration";
    public static final String SAVE_KEY = "save_token";
    public static final String TOKEN_SECRET = "token_secret";
    public static final String FILE_SIZE = "file_size";
    public static final String FILE_MD5 = "file_hash";

    public static final String UPLOAD_VIDEO_ACTION = "cc_upload_action";

    /*******时光树权限常量*************************/
    public static final int PARENT_COMUNICATE_RIGHTS = 115; // 控制家长之间能不能聊天的权限
    public static final int PARENT_ADDVALUE_RIGHTS = 117;   // 控制家长之间能不能聊天的权限
